...
class ResponseParser_ArduinoJson6 {
/*
...
public:
  ...
  explicit
#endif
  ResponseParser_ArduinoJson6(basic_Error & e) {}
...
using ResponseParser_ArduinoJson6 = ::cryptolens_io::v20190401::ResponseParser_ArduinoJson6;
